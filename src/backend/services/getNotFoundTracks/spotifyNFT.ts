...
export const getNotFoundTracksFromSpotify = async (userId: string) => {
  try {
    ...
    const legacyRow = await prisma.spotifyData.findFirst({
      where: { userId },
