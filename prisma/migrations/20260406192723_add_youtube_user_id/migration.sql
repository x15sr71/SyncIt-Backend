/*
  ...
  - A unique constraint covering the columns `[youtube_user_id]` on the table `YouTubeData` will be added. If there are existing duplicate values, this will fail.
  ...
  - Added the required column `youtube_user_id` to the `YouTubeData` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "YouTubeData" ADD COLUMN     "youtube_user_id" TEXT NOT NULL;
